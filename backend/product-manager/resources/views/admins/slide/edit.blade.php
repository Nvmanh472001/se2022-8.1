            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12 justify-content-md-center">
                        <form action="{{ route('admins.slides.update', ['id' => $slide->id]) }}"
                            ...
                            <div class="col-md-4 float-left">
                                <div class="form-group">
                                    ...
                                    @if (!$slide->image == null)
                                        <div class="col-md-8 container">
                                            <img class="image_item " width="100%" src="{{ $slide->image }}"
                                                alt="{{ $slide->name }}">
                                        </div>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" required value="" id="description">{{ old('description') }} {{ $slide->description }}</textarea>
                                </div>
