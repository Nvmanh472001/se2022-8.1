...
<div class="content-wrapper">
    ...
    @include('admins.partials.content-header',['name'=>'Menu', 'key'=>'Update'])
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('admins.menus.update',['id'=>$menu->id])}}" method="post>
                    @csrf
                    <div class="form-group">
                      <label class="form-label">Tên Danh Mục</label>
                      <input type="text" class="form-control" value="{{$menu->name}}" placeholder="Vui lòng nhập tên danh mục ..." name ="name" required>
                        @error('name')
