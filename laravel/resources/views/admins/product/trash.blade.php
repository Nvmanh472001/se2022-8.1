    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('admins.products.index') }}" class=" btn btn-outline-info float-left m-2"> <i class="bi bi-arrow-counterclockwise"></i> Quay lại</a>
                    </div>
                                    ...
                                    @foreach ($product as $key => $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('product_restore')
                                                <a href=""
                                                data-url="{{ route('admins.products.restore', ['id' => $value->id]) }}"
                                                class="btn btn-info action_restore">Khôi phục</a>
                                                @endcan
                                                 @can('product_deleteforcus')
                                                 <a href=""
                                                     data-url="{{ route('admins.products.deleteForcus', ['id' => $value->id]) }}"
